...
if(isset($_POST['login']) && $_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $query="SELECT * FROM `employees table` WHERE `E-Mail`='$loginemail' and `Employees_Role` = 'Employee';";
    ...
    if($check){
        if(mysqli_num_rows($check)==1){
         ...
         $employeerole=$row['Employees_Role'];
            ...
            echo "<script>alert('You Not Employee') 
                    ...
                    <div class="auth-content">
                        ...
                        <form id="login-form" action="" method="post" >
                            ...
                            <div class="form-group py-3">
                                <button type="submit" name="login" id="login" class="btn border border-secondary px-4 py-2 rounded-pill active text-primary w-100">Login</button>
                            </div>
