                ...
                <div class="p-5  rounded  ">
                    ...
                    <div class=" top border-secondary">
                                ...
                                <div class="px-4 py-3 rounded-bottom">
                                        ...
                                        <h5 class="text-primary disp"><?= $_SESSION['Customer_Name']?></h5>
                        ...
                        <div class="form col-lg-5 mb-5 bg-dark w-40 ">
                        <h2>User Profile</h2>
                            <form class="contactForm">
                            <div class="form-group py-3 radius">
                                <h3 class="text-left  text-secondary ">User Id :  </h3> 
                                <h4 class="text-left py-3 text-white "><?= $_SESSION['Customer_Id']?></h3>
                                </div>
                              
                            <div class="form-group py-3 radius">
                                <h3 class="text-left  text-secondary ">User Name :  </h3> 
                                <h4 class="text-left py-3 text-white "> <?= $_SESSION['Customer_Name']?></h3>
                                </div>
                      
                                <div class="form-group py-3 radius">
                                <h3 class="text-left  text-secondary ">User E-Mail :  </h3> 
                                <h4 class="text-left py-3  text-white "><?= $_SESSION['E_Mail']?></h3>
                                </div>
