       ...
       <div class="container-fluid bg-dark fixed-top">
        ...
        <div class="container-fluid page-header  py-5" style="background-image: url('../index/img/Admin.jpg');">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <a href="itemslist.php" class="breadcrumb-item ">Product List</a>
...
<thead>
    ...
    <a href="itemslist.php" class=" btn  border border-secondary px-4 py-3 rounded-pill text-primary w-50">Click Now</a> </h1>';
}
        }
        else{
...
<div class="col-12">
    <div class="pagination d-flex justify-content-center mt-5">
       ...
       if($page >1){
        echo '<a href="itemslist.php?page='.($page -1).'" class="rounded">&laquo;</a>';
       }
       ...
       for ($i=1; $i <= $totalpage; $i++) { 
        ...
        echo '<a href="itemslist.php?page='.$i.'" class="'.$active.' rounded">'.$i.'</a>';
       }
       if($page < $totalpage){
        echo ' <a href="itemslist.php?page='.($page +1).'" class="rounded">&raquo;</a>';
       }
