...
<style>
    ...
    <body>
       ...
       <div class="container-fluid bg-dark fixed-top">
               ...
               <button class="navbar-toggler py-2 px-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                    ...
                    <div class="navbar-nav mx-auto">
                        ...
                        <div class="position-relative ">
                            <form action="ordershipped.php" role="search" method="get">
        ...
        <ol class="breadcrumb justify-content-center  mb-0 ">
                ...
                <a href="orderdispatchtable.php" class="breadcrumb-item text-white">DISPATCH</a>
                <a href="ordershipped.php" class="breadcrumb-item ">SHIPPED</a>
            </ol>
    </div>
    ...
    if(isset($_GET['Add'])){
        $search=$_GET['Add'];
        $searchquery="SELECT * FROM `order_tale` as O WHERE `Order_Status`= 'Shipped' and O.Order_Id LIKE '%$search%' or O.Order_Date LIKE '%$search%' or  O.Delivery_type LIKE '%$search%' or  O.Payment_type LIKE '%$search%'  ;";
...
<thead>
    ...
    <th scope="col" class="">Order Id</th>
      ...
      <th scope="col">Order Status</th>
            ...
            while($runsearch=mysqli_fetch_assoc($searchrun)){
                if($runsearch['Order_Status']=='Shipped'){
           ...
           <tr>
                ...
                <td class="py-3"><?=$runsearch['Order_Date'] ?></td>
                <td class="py-3"><?=$runsearch['Delivery_type'] ?></td>
                <td class="py-3"><?=$runsearch['Payment_type'] ?></td>
                <td class="py-3"><?=$runsearch['Order_Status'] ?></td>
    ...
    <a href="ordershipped.php" class=" btn  border border-secondary px-4 py-3 rounded-pill text-primary w-50">Click Now</a> </h1>';
}
}
        else{
        ...
        $offset=($page - 1 )*$limit;
        $product="SELECT * FROM `order_tale` WHERE `Order_Status`= 'Shipped' limit $offset,$limit";
      ...
      <th scope="col">Order Status</th>
            ...
            while($row=mysqli_fetch_assoc($productcheck)){
                ...
                <tr>
                    ...
                    <td class="py-3"><?=$row['Order_Date'] ?></td>
                    <td class="py-3"><?=$row['Delivery_type'] ?></td>
...
<div class="col-12">
    <div class="pagination d-flex justify-content-center mt-5">
        <?php
        $pageination="SELECT * FROM `order_tale` WHERE `Order_Status`= 'Shipped';";
       ...
       if($page >1){
        echo '<a href="ordershipped.php?page='.($page -1).'" class="rounded">&laquo;</a>';
       }
       ...
       for ($i=1; $i <= $totalpage; $i++) { 
        ...
        echo '<a href="ordershipped.php?page='.$i.'" class="'.$active.' rounded">'.$i.'</a>';
       }
       if($page < $totalpage){
        echo ' <a href="ordershipped.php?page='.($page +1).'" class="rounded">&raquo;</a>';
       }
