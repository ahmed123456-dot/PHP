...
<style>
       ...
       <div class="container-fluid bg-dark fixed-top">
               ...
               <button class="navbar-toggler py-2 px-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                    ...
                    <div class="navbar-nav mx-auto">
                        ...
                        <div class="position-relative ">
                            <form action="delete.php" role="search" method="get">
        ...
        <div class="container-fluid page-header  py-5" style="background-image: url('../index/img/Admin.jpg');">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <a href="delete.php" class="breadcrumb-item ">Delete</a>
    ...
    if(isset($_GET['Add'])){
        $search=$_GET['Add'];
        $searchquery="SELECT * FROM `products table` as P INNER JOIN category_table as C on P.Category_Id=C.Category_Id WHERE `Status`= 1 and P.Product_Name LIKE '%$search%' or P.Price LIKE '%$search%' or  C.Category_Name LIKE '%$search%';";
...
<thead>
    ...
    <th scope="col" class="">Id</th>
      ...
      <th scope="col">Delete</th>
            ...
            <tr>
                ...
                <td><img class="image" src="img/<?=$runsearch['Image']?>" alt=""></td>
                ...
                <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="deletepage.php?Id='.$runsearch['Product_Id'].'" class="btn btn-danger  px-3 py-2 rounded-pill text-secondary w-100">DELETE</a>';
               ?> </td>
    ...
    <a href="delete.php" class=" btn  border border-secondary px-4 py-3 rounded-pill text-primary w-50">Click Now</a> </h1>';
}
        }
        else{
        ...
        $offset=($page - 1 )*$limit;
        $product="SELECT * FROM `products table` as P INNER JOIN category_table as C on P.Category_Id=C.Category_Id WHERE `Status`= 1 ORDER BY Product_Id ASC limit $offset,$limit";
      ...
      <th scope="col">Delete</th>
            ...
            while($row=mysqli_fetch_assoc($productcheck)){
                ...
                <tr>
                    ...
                    <td><img class="image" src="img/<?=$row['Image']?>" alt=""></td>
                    ...
                    <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="deletepage.php?Id='.$row['Product_Id'].'" class="btn btn-danger  px-3 py-2 rounded-pill text-secondary w-100">DELETE</a>';
               ?> </td>
...
<div class="col-12">
    <div class="pagination d-flex justify-content-center mt-5">
       ...
       if($page >1){
        echo '<a href="delete.php?page='.($page -1).'" class="rounded">&laquo;</a>';
       }
       ...
       for ($i=1; $i <= $totalpage; $i++) { 
        ...
        echo '<a href="delete.php?page='.$i.'" class="'.$active.' rounded">'.$i.'</a>';
       }
       if($page < $totalpage){
        echo ' <a href="delete.php?page='.($page +1).'" class="rounded">&raquo;</a>';
       }
