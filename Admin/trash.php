    ...
    <th scope="col" class="">Id</th>
      ...
      <th scope="col">Delete</th>
            ...
            <tr>
                ...
                <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="Restore.php?Id='.$runsearch['Product_Id'].'" class="btn btn-success  px-3 py-2 rounded-pill text-secondary w-100">RESTORE</a>';
               ?> </td>
               <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="permenantdelete.php?Id='.$runsearch['Product_Id'].'" class="btn btn-danger  px-3 py-2 rounded-pill text-secondary w-100">DELETE</a>';
               ?> </td>
            </tr>
            <?php
                }
      ...
      <th scope="col">Delete</th>
            ...
            while($row=mysqli_fetch_assoc($productcheck)){
                ...
                <tr>
                    ...
                    <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="Restore.php?Id='.$row['Product_Id'].'" class="btn btn-success  px-3 py-2 rounded-pill text-secondary w-100">RESTORE</a>';
               ?> </td>
               <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="permenantdelete.php?Id='.$row['Product_Id'].'" class="btn btn-danger  px-3 py-2 rounded-pill text-secondary w-100">DELETE</a>';
               ?> </td>
                </tr>
                <?php
