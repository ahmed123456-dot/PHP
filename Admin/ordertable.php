...
<style>
    ...
    <body>
       ...
       <div class="container-fluid bg-dark fixed-top">
               ...
               <button class="navbar-toggler py-2 px-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                    ...
                    <div class="navbar-nav mx-auto">
                        ...
                        <div class="position-relative ">
                            <form action="ordertable.php" role="search" method="get">
        ...
        <ol class="breadcrumb justify-content-center  mb-0 ">
                ...
                <a href="ordertable.php" class="breadcrumb-item ">PENDING </a>
    ...
    if(isset($_GET['Add'])){
        $search=$_GET['Add'];
        $searchquery="SELECT * FROM `order_tale` as O WHERE `Order_Status`= 'Pending' and O.Order_Id LIKE '%$search%' or O.Order_Date LIKE '%$search%' or  O.Delivery_type LIKE '%$search%' or  O.Payment_type LIKE '%$search%' ;";
...
<thead>
    ...
    <th scope="col" class="">Order Id</th>
      ...
      <th scope="col">DISPATCH</th>
            ...
            while($runsearch=mysqli_fetch_assoc($searchrun)){
                if($runsearch['Order_Status']=='Pending'){
           ...
           <tr>
                ...
                <td>
                <?php
           echo ' <a type="button" id="ahmed" href="dispatchupdate.php?Id='.$runsearch['Order_Id'].'" class="btn btn-success  px-3 py-2 rounded-pill text-secondary w-100">DISPATCH</a>';
           ?> </td>
            </tr>
            <?php
              }   
    ...
    <a href="ordertable.php" class=" btn  border border-secondary px-4 py-3 rounded-pill text-primary w-50">Click Now</a> </h1>';
}
}
        else{
        ...
        $offset=($page - 1 )*$limit;
        $product="SELECT * FROM `order_tale` WHERE `Order_Status`= 'Pending' limit $offset,$limit";
      ...
      <th scope="col">DISPATCH</th>
            ...
            while($row=mysqli_fetch_assoc($productcheck)){
                ...
                <tr>
                    ...
                    <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="dispatchupdate.php?Id='.$row['Order_Id'].'" class="btn btn-success  px-3 py-2 rounded-pill text-secondary w-100">DISPATCH</a>';
               ?> </td>
                </tr>
                <?php
...
<div class="col-12">
    <div class="pagination d-flex justify-content-center mt-5">
        <?php
        $pageination="SELECT * FROM `order_tale` WHERE `Order_Status`= 'Pending';";
