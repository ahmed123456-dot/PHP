       ...
       <div class="container-fluid bg-dark fixed-top">
        ...
        <div class="container-fluid page-header  py-5" style="background-image: url('../index/img/Admin.jpg');">
            ...
            <ol class="breadcrumb justify-content-center mb-0">
                ...
                <a href="updatepage.php" class="breadcrumb-item  ">Update</a>
...
<thead>
    ...
    <th scope="col" class="">Id</th>
      ...
      <th scope="col">Update</th>
            ...
            <tr>
                ...
                <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="update.php?Id='.$runsearch['Product_Id'].'" class="btn btn-success  px-3 py-2 rounded-pill text-secondary w-100">UPDATE</a>';
               ?> </td>
            </tr>
            <?php
              }   
    ...
    <a href="updatepage.php" class=" btn  border border-secondary px-4 py-3 rounded-pill text-primary w-50">Click Now</a> </h1>';
}
        }
        else{
      ...
      <th scope="col">UPdate</th>
            ...
            while($row=mysqli_fetch_assoc($productcheck)){
                ...
                <tr>
                    ...
                    <td>
                    <?php
               echo ' <a type="button" id="ahmed" href="update.php?Id='.$row['Product_Id'].'" class="btn btn-success  px-3 py-2 rounded-pill text-secondary w-100">UPDATE</a>';
               ?> </td>
                </tr>
                <?php
...
<div class="col-12">
    <div class="pagination d-flex justify-content-center mt-5">
       ...
       if($page >1){
        echo '<a href="updatepage.php?page='.($page -1).'" class="rounded">&laquo;</a>';
       }
       ...
       for ($i=1; $i <= $totalpage; $i++) { 
        ...
        echo '<a href="updatepage.php?page='.$i.'" class="'.$active.' rounded">'.$i.'</a>';
       }
       if($page < $totalpage){
        echo ' <a href="updatepage.php?page='.($page +1).'" class="rounded">&raquo;</a>';
       }
